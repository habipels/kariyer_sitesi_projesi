...
with open('C:/Users/habip/OneDrive/Masaüstü/kari_yer/neos_kariyer/iyzipay-python-1.0.37/README.md') as f:
    README = f.read()

with open('C:/Users/habip/OneDrive/Masaüstü/kari_yer/neos_kariyer/iyzipay-python-1.0.37/LICENSE') as f:
    LICENSE = f.read()
